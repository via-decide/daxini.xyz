...
import { validateRequestBody } from '../security/inputSanitizer.js';
import { logLoginAttempt, logPromptInjection, logUnusualActivity } from '../security/securityLogger.js';
...
export default async function handler(req, res) {
  try {
    ...
    if (path === '/api/sop/classify' || path === '/api/sop/validate') {
        ...
        } catch (_e) { /* ignore dynamic config failure */ }
